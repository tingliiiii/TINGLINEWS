...
// 用戶端編號: 
// 用戶端密鑰: 
// 回調的 URI: http://localhost:8080/tinglinews/callback/google
...
public class OIDCUtil {
	...
	private static final String REDIRECT_URI = "http://localhost:8080/tinglinews/callback/google"; // 回調的 URI
		...
		try {
	        ...
	        try {
	            ...
	            if (statusCode == 200) {
	                ...
	                // 處理錯誤響應
	            	responseDetails.put("error", Integer.toString(statusCode) + " error");
	            }
	        } finally {
